...
library(pacman)
p_load(RColorBrewer, ggplot2, rvest, Rcrawler, readtext, knitr, googlesheets4, dplyr,
       igraph, tictoc)
...
nrcs.db[nrcs.db[, "H3"] == "Energy, Combustion, and Electricity Efficiency", 
        "H4"] <- c("Irrigation Pipeline",
                   "Irrigation System, Microirrigation",
                   "Sprinkler System",
                   "Pumping Plant", 
                   "Energy Efficient Lighting System")
## H4 is NA
nrcs.db[is.na(nrcs.db[, "H4"]), "H3"] <- "Conservation Efforts" 
nrcs.db[is.na(nrcs.db[, "H4"]), "H4"] <- "Support Pollinators" 
